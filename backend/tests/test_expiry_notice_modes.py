...
def test_personal_deadline_is_not_missed_when_base_date_is_far(stack):  # noqa: F811 - pytest fixture injection
    db, _groups, members, now, overrides = stack
...
def test_traffic_only_stale_deadline_does_not_send_expiry_reminder(stack):  # noqa: F811 - pytest fixture injection
    db, _groups, members, now, overrides = stack
...
def test_explicit_unlimited_overlay_suppresses_base_reminder(stack):  # noqa: F811 - pytest fixture injection
    db, _groups, members, now, overrides = stack
